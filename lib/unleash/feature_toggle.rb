...
module Unleash
  class FeatureToggle
    ...
    def get_variant_from_override_match(context)
    ...
    def get_variant_from_weights(context)
      variant_weight = Unleash::Strategy::Util.get_normalized_number(get_variant_salt(context), self.name, get_sum_variant_defs_weights())
      prev_weights = 0
